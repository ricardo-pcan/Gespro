...
import com.tsp.gespro.exceptions.SgfensPedidoImpuestoDaoException;
...
import com.tsp.gespro.pdf.Translator;
...
*/            pedidoDto.setSubtotal(pedidoSesion.calculaSubTotal().doubleValue());
            ...
            pedidoDto.setIdTipoPedido(pedidoSesion.getIdTipoPedido());
...
*/                prodPedido.setCantidadEntregada(prodSesion.getCantidadEntregada());
                ...
                prodPedido.setAptoParaVenta(prodSesion.getAptoParaVenta());
                prodPedido.setNoAptoParaVenta(prodSesion.getNoAptoParaVenta());
                prodPedido.setIdClasificacion(prodSesion.getIdClasificacion());
                prodPedido.setComentarios(prodSesion.getComentarios());
            ...
            //CONTENIDO -------------
                ...
                //Cabecera (Datos Generales)---------------------
                    ...
                    //Datos de Cliente/Prospecto
                        ...
                        try{
                            obj.agregaCelda(tAux,letraOcho, "Nombre : " + (clienteDto!=null?clienteDto.getNombreComercial():""), new boolean[]{false,true,false,false}, Element.ALIGN_LEFT, Element.ALIGN_TOP, 0, new int[0],1);
...
*/                    
                ...
                // Devoluciones -----------                     
                    ...
                    if(devoluciones.length>0){
                        ...
                        tDetallesDev.setWidths(new int[]{190,90,90,90,90});
                       ...
                       /*CABECERA*/                        
                        ...
                        obj.agregaCelda(tDetallesDev, letraNueveBold, Color.lightGray, "Devoluciones",
                                new boolean[]{true, true, true, true}, Element.ALIGN_CENTER, Element.ALIGN_MIDDLE, 15, new int[]{5, 5, 5, 5}, 5);                        
                ...
                //FIN Devoluciones ----------    
                    ...
                    if(cambios.length>0){
                        ...
                        tDetallesCambios.setWidths(new int[]{190,90,90,90,90});
...
*/                        
     ...
     public File guardarRepresentacionImpresa(UsuarioBO userSesion) throws FileNotFoundException, Exception {
        ...
        rutaRepositorio = configuration.getApp_content_path() + empresaDto.getRfc() + "/pedidos/Gespro" ;
    ...
    public SgfensPedido[] findByPedidosPorZona(int idPedido, int idEmpresa, int minLimit,int maxLimit, String filtroBusqueda, String ascDesc) {
        ...
        SgfensPedidoDaoImpl pedidoDao = new  SgfensPedidoDaoImpl(this.conn);
            ...
            //EL VALOR DEL CONTADOR, QUE RETORNA LA BASE DE DATOS, DE NUMERO DE PEDIDOS QUE TIENE EL VENDEDOR VA A CAER EN EL ATRIBUTO DE ID_CLIENTE
             ...
             try {
                String sqlFiltro="SELECT ID_PEDIDO, ID_USUARIO_VENDEDOR, sgp.ID_EMPRESA, COUNT(emp.ID_REGION) AS 'ID_CLIENTE', CONSECUTIVO_PEDIDO, FOLIO_PEDIDO, FECHA_PEDIDO, TIPO_MONEDA, TIEMPO_ENTREGA_DIAS, COMENTARIOS, DESCUENTO_TASA, DESCUENTO_MONTO, SUBTOTAL, SUM(TOTAL) AS 'TOTAL', DESCUENTO_MOTIVO, FECHA_ENTREGA, FECHA_TENTATIVA_PAGO, SUM(SALDO_PAGADO + ADELANTO) AS SALDO_PAGADO, ADELANTO, ID_COMPROBANTE_FISCAL, ID_ESTATUS_PEDIDO, sgp.LATITUD, sgp.LONGITUD, FOLIO_PEDIDO_MOVIL, NOMBRE_IMAGEN_FIRMA, IS_MODIFICADO_CONSOLA, BONIFICACION_DEVOLUCION, ID_USUARIO_CONDUCTOR_ASIGNADO, emp.ID_REGION AS ID_USUARIO_VENDEDOR_ASIGNADO ,ID_USUARIO_VENDEDOR_REASIGNADO,FECHA_LIMITE_REASIGANCION,sgp.SINCRONIZACION_MICROSIP,CONSIGNA,SINCRONIZACION_MICROSIP,ID_VIA_EMBARQUE "
