...
import com.tsp.gespro.dto.Productosvendidos;
import com.tsp.gespro.dto.SgfensPedido;
...
import com.tsp.gespro.jdbc.ProductosvendidosDaoImpl;
        ...
        try{            
            ...
            //CONTENIDO -------------
                ...
                /*CABECERA*/                  
                    ...
                    String filtroBusqueda =" ID_PEDIDO IN ( SELECT ID_PEDIDO FROM sgfens_pedido WHERE ID_EMPRESA = '"+this.degustacion.getIdEmpresa()+"' AND ID_TIPO_PEDIDO = 2 AND ID_USUARIO_VENDEDOR = "+this.degustacion.getIdUsuario()+" AND "
                            + " ID_ESTATUS_PEDIDO<>2 AND FECHA_PEDIDO BETWEEN '"+ this.degustacion.getFechaApertura() +"'  AND '"+this.degustacion.getFechaCierre()+"') ";
                    ...
                    if(pedidoProductoDto.length>0){
                        ...
                        obj.agregaCelda(tVenta, letraOcho, null, "No se registrarón datos.",
                                new boolean[]{true, true, true, true}, Element.ALIGN_CENTER, Element.ALIGN_MIDDLE, 15, new int[]{5, 5, 5, 5}, 4); 
