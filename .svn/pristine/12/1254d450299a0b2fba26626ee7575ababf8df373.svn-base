...
import com.tsp.gespro.jdbc.SgfensPedidoImpuestoDaoImpl;
import com.tsp.gespro.jdbc.SgfensPedidoProductoDaoImpl;

import com.tsp.gespro.util.Base64;
...
import com.tsp.gespro.sesion.ImpuestoSesion;
import com.tsp.gespro.sesion.PedidoSesion;
import com.tsp.gespro.sesion.ProductoSesion;
import com.tsp.gespro.ws.request.*;
import com.tsp.gespro.ws.response.*;
import java.io.File;
                            ...
                            if (pedidoDtoExistentes[0].getIdPedido()>0){
                                ...
                                /*if (crearPedidoRequest.getEntregado() == SGEstatusPedidoBO.ESTATUS_ENTREGADO
                                    ...
                                    for (WsItemConceptoRequest wsConcepto : crearPedidoRequest.getWsItemConceptoRequest()){
                                        ...
                                        nuevoProductoCompraSesion.setAptoParaVenta(wsConcepto.getAptoParaVenta());
                                        nuevoProductoCompraSesion.setNoAptoParaVenta(wsConcepto.getNoAptoParaVenta());
                                        nuevoProductoCompraSesion.setIdClasificacion(wsConcepto.getIdClasificacion());
                                        nuevoProductoCompraSesion.setComentarios(wsConcepto.getComentarios());
                                    ...
                                    UsuarioBO usuarioBO = empleadoBO;
...
*/                    
                    ...
                    try{
                        pedidoSesion.setComentarios("Pedido registrado desde aplicación móvil, Folio Pedido Movil: "+ crearPedidoRequest.getFolioPedidoMovil()
                            +". Registrado en servidor: " + (ZonaHorariaBO.DateZonaHorariaByIdEmpresa(getConn(), new Date(), (int)idEmpresa).getTime()) );
                    }catch(Exception e){
                        pedidoSesion.setComentarios("Pedido registrado desde aplicación móvil, Folio Pedido Movil: "+ crearPedidoRequest.getFolioPedidoMovil()
                 ...
                 //pedidoSesion.setAdelanto(montoAbonoInicial);
                    ...
                    if (crearPedidoRequest.getWsDatosMetodoPagoRequest()!=null){
                        if (crearPedidoRequest.getWsDatosMetodoPagoRequest().getMetodoPagoId()==VentaMetodoPagoBO.METODO_PAGO_CREDITO){
                            ...
                            try{
                                pedidoSesion.setFechaTentativaPago( (ZonaHorariaBO.DateZonaHorariaByIdEmpresa(getConn(), new Date(), (int)idEmpresa).getTime()) );
                            }catch(Exception e){
                    ...
                    pedidoSesion.setIdTipoPedido(crearPedidoRequest.getIdTipoPedido());
...
*/                    
                    ...
                    if (!crearPedidoRequest.isVentaGenerica()
                            && crearPedidoRequest.getIdEstatus()== SGEstatusPedidoBO.ESTATUS_ENTREGADO ){
//                         stockSuficiente = pedidoSesion.salidaAlmacenProductosInventarioEmpleado(empleadoBO.getEmpleado().getIdEmpleado()); 
                    }else if(!crearPedidoRequest.isVentaGenerica()
                            && crearPedidoRequest.getIdEstatus()== SGEstatusPedidoBO.ESTATUS_ENTREGADO_PARCIAL){
//                        stockSuficiente = pedidoSesion.salidaParcialAlmacenProductosInventarioEmpleado(empleadoBO.getEmpleado().getIdEmpleado()); 
                    }/*else{
                        response.setError(true);
                        response.setNumError(901);
                        response.setMsgError("Tipo de Entrega no valida Inserta. IdEstatus: " + crearPedidoRequest.getIdEstatus() );
                        return response;
                    }*/
...
//                    try{new InsertaActualizaWsBO(getConn()).actualizarUbicacionUsuario(empleadoDtoRequest);}catch(Exception ex){}
                    ...
                    if (pedidoBO.getPedido()!=null){       
                        try{
                            ...
                            for (WsItemConceptoRequest wsConcepto : modificarPedidoRequest.getWsItemConceptoRequest()){
                                ...
                                pedidoProductoDto.setAptoParaVenta(wsConcepto.getAptoParaVenta());
                                pedidoProductoDto.setNoAptoParaVenta(wsConcepto.getNoAptoParaVenta());
                                pedidoProductoDto.setIdClasificacion(wsConcepto.getIdClasificacion());
                                pedidoProductoDto.setComentarios(wsConcepto.getComentarios());
...
//                            pedidoBO.actualizaSalidaAlmacenProductosInventarioEmpleado(empleadoBO.getEmpleado().getIdEmpleado() , listaProducto);
                            ...
                            pedidoBO.getPedido().setIdTipoPedido(modificarPedidoRequest.getIdTipoPedido());
    ...
    public ConsultaPedidosResponse getPedidosByEmpleado(EmpleadoDtoRequest empleadoDtoRequest, ConsultaPedidosRequest consultaPedidosRequest){
        ...
        try{
            ...
            if (empleadoBO.login(empleadoDtoRequest.getEmpleadoUsuario(), empleadoDtoRequest.getEmpleadoPassword())) {
                ...
                int idUsuario = empleadoBO.getUser().getIdUsuarios();
...
*/            
            for (SgfensPedido pedidoDto : pedidosDtoArray){
                ...
                wsItemPedido.setIdTipoPedido(pedidoDto.getIdTipoPedido());
                ...
                { //Conceptos (productos / servicios)  
                    ...
                    for (SgfensPedidoProducto pedidoProdDto : pedidoProductosDto) {
                        ...
                        wsPConcepto.setAptoParaVenta(pedidoProdDto.getAptoParaVenta());
                        wsPConcepto.setNoAptoParaVenta(pedidoProdDto.getNoAptoParaVenta());
                        wsPConcepto.setIdClasificacion(pedidoProdDto.getIdClasificacion());
                        wsPConcepto.setComentarios(pedidoProdDto.getComentarios());
