<%-- 
    Document   : catSucursales_list
    Created on : 28/11/2012, 04:47:48 PM
    Author     : Leonardo
--%>
...
if (user == null || !user.permissionToTopicByURL(request.getRequestURI().replace(request.getContextPath(), ""))) {
    ...
    */
    ...
    try{
     ...
     try{
         limiteRegistros = empresaBO.findEmpresas(idEmpresa, idEmpresa , 0, 0, filtroBusqueda).length;
        ...
        empresasDto = empresaBO.findEmpresas(idEmpresa, idEmpresa,
    ...
    * Datos de catálogo
    */
    String urlTo = "../catSucursales/catSucursales_form.jsp";
                    ...
                    <div class="onecolumn">
                                ...
                                <table width="500px" cellpadding="0" cellspacing="0">
                                    <tbody>
                                        <tr>
                                            <td>
                                                <div id="search">
                                                <form action="catSucursales_list.jsp" id="search_form" name="search_form" method="post">
                                                        <input type="text" id="q" name="q" title="Buscar por Nombre Comercial" class="" style="width: 300px; float: left; "
                                                                value="<%=buscar%>"/>
                        ...
                        <div class="content">
                                ...
                                <table class="data" width="100%" cellpadding="0" cellspacing="0">
                                    ...
                                    <tbody>
                                        ...
                                        <tr <%=(item.getIdEstatus()!=1)?"class='inactive'":""%>>                                          
                                            ...
                                            <td>                                           
                                                <a href="<%=urlTo%>?<%=paramName%>=<%=item.getIdEmpresa()%>&acc=1&pagina=<%=paginaActual%>"><img src="../../images/icon_edit.png" alt="editar" class="help" title="Editar"/></a>
                            ...
                            <!--<//jsp:include page="../include/reportExportOptions.jsp" flush="true">
                                <//jsp:param name="idReport" value="<%//= ReportBO.SUCURSAL_REPORT %>" />
