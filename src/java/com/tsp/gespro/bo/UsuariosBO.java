...
public class UsuariosBO {
    ...
    public String getUsuariosByHTMLCombo(int idEmpresa, int idSeleccionado, String filtroBusqueda){
        String strHTMLCombo ="";

        try{
            
            Usuarios[] usuariosDto = findUsuarios(-1,idEmpresa, -1,-1,filtroBusqueda);
