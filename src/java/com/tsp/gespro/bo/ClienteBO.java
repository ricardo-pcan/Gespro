...
import com.tsp.gespro.exceptions.ClienteDaoException;
            ...
            for (Cliente itemCliente:clientesDto){
                try{
                    ...
                    strHTMLCombo += "<option value='"+itemCliente.getIdCliente()+"' "
                            + selectedStr
                            + "title='"+itemCliente.getNombreComercial()+"'>"
                            + itemCliente.getNombreComercial()
                            +"</option>";
                }catch(Exception ex){
                    ex.printStackTrace();
                }
...
*/            clienteDto.setNombreComercial("Cliente Genérico");
...
//            clienteDto.setCelular("");
    ...
    */
    ...
    public Cliente getClienteByNombreComercialSocial(long idEmpresa, String razonSocial) throws Exception{
        Cliente cliente = null;
        ...
        try{
            ...
            cliente = ConceptoDaoImpl.findByDynamicWhere(" NOMBRE_COMERCIAL = '" + razonSocial +"' AND "
