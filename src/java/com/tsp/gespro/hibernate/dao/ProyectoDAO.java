...
public class ProyectoDAO {
    ...
    public void actualizar(Proyecto object) throws HibernateException 
    { 
        try 
        { 
    ...
    { 
        ...
        { 
            iniciaOperacion(); 
            Proyecto object = (Proyecto) sesion.get(Proyecto.class,id); 
    ...
    public Proyecto getById(int id) throws HibernateException 
    { 
        ...
        { 
            iniciaOperacion(); 
            object = (Proyecto) sesion.get(Proyecto.class,id);
        } finally 
        { 
            sesion.close(); 
        }  
