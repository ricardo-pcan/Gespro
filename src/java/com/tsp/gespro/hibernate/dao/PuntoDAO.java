...
public class PuntoDAO {
    ...
    public Integer guardar(Punto object) throws HibernateException 
    { 
        Integer id = 0;  
        try 
        { 
    ...
    public void actualizar(Punto object) throws HibernateException 
    { 
        try 
        { 
    ...
    { 
        ...
        { 
            iniciaOperacion(); 
            Punto object = (Punto) sesion.get(Punto.class,id); 
    ...
    public Punto getById(int id) throws HibernateException 
    { 
        ...
        { 
            iniciaOperacion(); 
            object = (Punto) sesion.get(Punto.class,id);
        } finally 
        { 
            sesion.close(); 
        }  
    ...
    { 
        ...
        { 
            iniciaOperacion(); 
            lista = sesion.createQuery("from punto").list(); 
        }
        finally 
        { 
            sesion.close(); 
