...
public class ProductoDAO {
    ...
    public Integer guardar(Producto object) throws HibernateException 
    { 
        Integer id = 0;  
        try 
        { 
    ...
    public void actualizar(Producto object) throws HibernateException 
    { 
        try 
        { 
    ...
    { 
        ...
        { 
            iniciaOperacion(); 
            Producto object = (Producto) sesion.get(Producto.class,id); 
    ...
    public Producto getById(int id) throws HibernateException 
    { 
        ...
        { 
            iniciaOperacion(); 
            object = (Producto) sesion.get(Producto.class,id);
        } finally 
        { 
            sesion.close(); 
        }  
