...
calls to this DAO, otherwise a new Connection will be allocated for each operation.
	 ...
	 */
	protected final String SQL_SELECT = "SELECT ID_DISPOSITIVO, ID_EMPRESA, ID_ESTATUS, IMEI, MARCA, MODELO, NUMERO_SERIE, ALIAS_TELEFONO, REPORTE_ROBO, ASIGNADO, PCT_PILA FROM " + getTableName() + "";
	 ...
	 */
	protected final String SQL_INSERT = "INSERT INTO " + getTableName() + " ( ID_DISPOSITIVO, ID_EMPRESA, ID_ESTATUS, IMEI, MARCA, MODELO, NUMERO_SERIE, ALIAS_TELEFONO, REPORTE_ROBO, ASIGNADO, PCT_PILA ) VALUES ( ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ? )";

	/** 
	 * SQL UPDATE statement for this table
	 */
	protected final String SQL_UPDATE = "UPDATE " + getTableName() + " SET ID_DISPOSITIVO = ?, ID_EMPRESA = ?, ID_ESTATUS = ?, IMEI = ?, MARCA = ?, MODELO = ?, NUMERO_SERIE = ?, ALIAS_TELEFONO = ?, REPORTE_ROBO = ?, ASIGNADO = ?, PCT_PILA = ? WHERE ID_DISPOSITIVO = ?";
	 ...
	 */
	protected static final int COLUMN_ALIAS_TELEFONO = 8;

	/** 
	 * Index of column REPORTE_ROBO
	 */
	protected static final int COLUMN_REPORTE_ROBO = 9;

	/** 
	 * Index of column ASIGNADO
	 */
	protected static final int COLUMN_ASIGNADO = 10;
		...
		try {
			...
			if (dto.isAsignadoModified()) {
				if (dto.isAsignadoNull()) {
					...
					stmt.setInt( index++, dto.getAsignado() );
				}
	 ...
	 */
	public DispositivoMovil[] findWhereAsignadoEquals(int asignado) throws DispositivoMovilDaoException
	{
		return findByDynamicSelect( SQL_SELECT + " WHERE ASIGNADO = ? ORDER BY ASIGNADO", new Object[] {  new Integer(asignado) } );
	}
	...
	protected void populateDto(DispositivoMovil dto, ResultSet rs) throws SQLException
	{
		...
		dto.setAsignado( rs.getInt( COLUMN_ASIGNADO ) );
		if (rs.wasNull()) {
