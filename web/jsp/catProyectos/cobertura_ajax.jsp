...
<%
    ...
    Coberturaproyecto obj= new Coberturaproyecto();
    CoberturaProyectoDAO proyecto = new CoberturaProyectoDAO();
...
obj.setIdCobertura(request.getParameter("idCobertura") != null ? Integer.parseInt(request.getParameter("idCobertura")): 0);
       ...
       try{ 
           ...
           if(obj.getIdCobertura()== 0 || obj.getIdProyecto() == 0){
